            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item {{ Request::is('dashboard/property*') ? 'active' : null }}"
                            href="{{ route('property') }}">Properties</a>
                        <a class="collapse-item {{ Request::is('dashboard/property*') ? 'active' : null }}"
                            href="{{ route('property') }}">Properties</a>
                        <a class="collapse-item {{ Request::is('dashboard/message*') ? 'active' : null }}"
                            href="{{ route('message') }}">Messages</a>
                    </div>
                </div>
            </li>
